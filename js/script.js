...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
    buildAndShowHomeHTML, // STEP 1: Substituted with the function
    true
  );
});

// Function to load a random single category menu page
dc.loadRandomSpecialCategory = function () {
  // Show loading icon
  showLoading("#main-content");
  ...
  $ajaxUtils.sendGetRequest(allCategoriesUrl, function (categories) {
    ...
    // Navigate to the menu items page for the random category
...
function buildAndShowHomeHTML(categories) {
  ...
  $ajaxUtils.sendGetRequest(
    homeHtmlUrl,
    function (homeHtml) {
      // STEP 2: Call chooseRandomCategory and retrieve the short name
